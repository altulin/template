...
"use strict";
/* WEBPACK VAR INJECTION */(function(setImmediate) {/* harmony import */ var body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
...
vars.getCookie = function (name) {
  ...
  var ca = document.cookie.split(";"); // eslint-disable-next-line no-plusplus
...
vars.lockScroll = function (state, $element, name) {
  ...
  if (state) {
    ...
    body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__[/* disableBodyScroll */ "b"](element, {
    ...
    body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__[/* enableBodyScroll */ "c"](element);

    if (!scrollLocks.size) {
      body_scroll_lock__WEBPACK_IMPORTED_MODULE_0__[/* clearAllBodyScrollLocks */ "a"]();
...
/* harmony default export */ __webpack_exports__["a"] = (vars);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return enableBodyScroll; });
...
var svg4everybody = __webpack_require__(4);
var svg4everybody_default = /*#__PURE__*/__webpack_require__.n(svg4everybody);

// CONCATENATED MODULE: ./_src/js/vendor.js


window.$ = jquery_default.a;
window.jQuery = jquery_default.a;
svg4everybody_default()();
// EXTERNAL MODULE: ./_src/js/helpers.js
var helpers = __webpack_require__(0);

// CONCATENATED MODULE: ./_src/js/modules/hover.js
...
function hasHoverSupport() {
  ...
  if (helpers["a" /* default */].isIE && helpers["a" /* default */].getScrollbarWidth()) {
    // On touch devices scrollbar width is usually 0
    hoverSupport = true;
  } else if (helpers["a" /* default */].isMobile()) {
    hoverSupport = false;
    ...
    hoverSupport = typeof helpers["a" /* default */].$html.ontouchstart === "undefined";
  }
...
if (!hasHoverSupport()) {
  helpers["a" /* default */].$html.removeClass("has-hover").addClass("no-hover");
} else {
  helpers["a" /* default */].$html.removeClass("no-hover").addClass("has-hover");
}
/**
...
function renderHover() {
  if (helpers["a" /* default */].winWidth !== window.innerWidth) {
    if (!hasHoverSupport()) {
      helpers["a" /* default */].$html.removeClass("has-hover").addClass("no-hover");
    } else {
      helpers["a" /* default */].$html.removeClass("no-hover").addClass("has-hover");
    ...
    helpers["a" /* default */].winWidth = window.innerWidth;
  }
}

/* harmony default export */ var hover = (renderHover);
// CONCATENATED MODULE: ./_src/js/modules/resize.js

var resizeTimeout;

var resize_actualResizeHandler = function actualResizeHandler() {
  hover();
};
